...
Example:
  node scripts/generate-signature.js POST /api/v1/launch 1725440000 sk_live_test '{"operatorId":"AAKDA-001","playerId":"P1001","gameCode":"TEENPATTI","currency":"INR","apiSecretPath":"gamotech/operators/AAKDA-001"}'
`);
  process.exit(1);
}
